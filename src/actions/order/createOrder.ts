...
import { CreateOrderDto, GetOrderDto } from '@/dtos/order/order.dto';
...
export const createOrder = catchAsync(async (createOrder: CreateOrderDto) => {
    await dbConnect();
